...
const homeFeedFeature: DemoFeature = {
  ...
  diffs: [
    { id: 'hf-d1', requirement: 'Sponsored Event Labeling', changeType: 'Disclosure visibility reduced — label hidden in menu', severity: 'Low', status: 'Open', tag: 'MISSING DISCLOSURE' },
    { id: 'hf-d2', requirement: 'Recommendation Explanation', changeType: 'Explanation affordance hidden behind long press', severity: 'Low', status: 'Open', tag: 'DESIGN CHANGE' },
    { id: 'hf-d3', requirement: 'Privacy Settings Access', changeType: 'Privacy settings entry point removed from feed', severity: 'Low', status: 'Open', tag: 'DESIGN CHANGE' },
    { id: 'hf-d4', requirement: 'Friend Attendance Display', changeType: 'Unconfirmed attendance shown as social signal', severity: 'Low', status: 'Open', tag: 'DESIGN CHANGE' },
    { id: 'hf-d5', requirement: 'A/B Test Scope', changeType: 'Experiment expanded 10%→35% without approval', severity: 'Low', status: 'Open', tag: 'POLICY CHANGE' },
  ],
  auditTrail: [
