...
import {
  AlertTriangle, ArrowRight, BellRing, Calendar, Check, CheckCircle,
  Code2, Database, FileCheck2, FileText,
  GitBranch, Layers, RefreshCw, Scale, Search, Shield, Sparkles, UserCheck, Users,
} from 'lucide-react';
import { LogoMark } from '../components/LogoMark';
import { LifecycleCinematic } from '../components/LifecycleCinematic';
    ...
    <main className="cc-marketing">
      <section className="cc-hero">
        <div className="cc-page">
          <div className="cc-hero-copy cc-hero-center">
            <div className="cc-kicker">
              <Sparkles className="h-3.5 w-3.5" />
              AI governance for fast-moving teams
            </div>
            <h1>
              Your product changes constantly.
              <span className="cc-hero-gradient">Can you keep up?</span>
            </h1>
            <p>
